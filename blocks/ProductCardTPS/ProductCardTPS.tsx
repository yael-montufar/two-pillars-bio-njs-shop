...
import ProductLoader from './ProductLoaderTPS'
...
const ProductCardTPS: React.FC<Props> = ({
  children,
  ...
  return (
    <StateProvider state={{ productCardState: productCardState }}>
      <React.Fragment>
        {children}
      </React.Fragment>
    </StateProvider>
...
const ProductView: React.FC<{
  ...
  return (
    <ProductLoader product={product}>
      {(productObject) => <ProductCardTPS {...props} product={productObject} />}
    </ProductLoader>
  )
}
